...
function listarServicosIndex()
{
    global $servicosIndex;

    foreach ($servicosIndex as $index => $servico) {
...
{
    global $servicosIndex;
    return $servicosIndex[$id]["nome"];
}
function getDescricao($id)
{
    global $servicosIndex;
    return $servicosIndex[$id]["descricao"];
}

function getImagem($id)
{
    global $servicosIndex;
    return $servicosIndex[$id]["imagem"];
}
